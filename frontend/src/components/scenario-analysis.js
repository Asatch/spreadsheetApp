...
export function createScenarioAnalysis({ scenarioEngine, container, scenarioId, folderId, preselectedFunctionId }) {
  ...
  function renderHeader() {
    ...
    header.innerHTML = `
      <div class="scenario-header-left">
        <a href="/" class="scenario-back-link">&larr; Sheets</a>
  ...
  function renderSetupPanel() {
    ...
    const sheetBase = loadedFunction.sheetType === 'loop' ? '/loop.html' : '/index.html';
    const sheetUrl = `${sheetBase}?id=${loadedFunction.sheetId}`;
