...
export async function createExportPackage({
  ...
  const depCount = expandedSheetIds.size - sheetIds.size;
  console.log('[ExportPackager] Created export package:', {
    selected: sheetIds.size,
    dependencies: depCount,
    total: expandedSheetIds.size,
    folders: neededFolders.size
  });
