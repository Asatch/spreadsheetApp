...
export function createPanelsComponent() {
  ...
  function mountInputs(panelElement) {
    ...
    inputsContainer.querySelector('.btn-add-input')?.addEventListener('click', handleAddInput);
  }
  ...
  function mountOutputs(panelElement) {
    ...
    panelElement.querySelector('.btn-add-output')?.addEventListener('click', handleAddOutput);
  }
